...
import { WisWorkMark } from '../ribbon-icons'
...
/** File-type icons for attachment cards (WisWork attachment icon set); exts the
...
export function AiChatPanel({
  ...
  /** data-URL previews for image attachments, keyed by path (WisWork composer thumbnails) */
