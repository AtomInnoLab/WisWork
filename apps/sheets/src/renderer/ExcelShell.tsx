...
import { platformShortcuts } from '@wiswork/i18n'
import { SHAPE_GALLERY_GROUPS, ShapePreview } from '@wiswork/ui'
    ...
    <main className={`app-shell ${isCopilotOpen ? '' : 'copilot-collapsed'}`}>
      ...
      <div className="sheet-body">
        <div className="sheet-main">
          ...
          {/* Status bar spans the sheet column only — the right AI dock keeps
...
function Ribbon({
  ...
  return (
    <div className="ribbon">
      ...
      <div className="ribbon-wiswork-sep" aria-hidden />
      <button
        className="ribbon-wiswork-btn"
