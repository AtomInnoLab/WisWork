...
export const aiStrings = defineStrings({
  zh: {
    ...
    aiWisWorkAccount: 'WisWork 账号',
    aiAccountChecking: '检测中…',
    aiLoggedIn: '已登录',
    aiLoggedInAs: '已登录：{email}',
    aiNotLoggedIn: '未登录（AI 功能需要登录 WisWork 账号）',
    aiWaitingBrowserLogin: '等待浏览器登录…',
    aiLoginWisWork: '登录 WisWork',
    aiModel: '模型',
    aiCancel: '取消',
    aiSave: '保存',
    aiUnknownError: '未知错误',
  ...
  en: {
    ...
    aiWisWorkAccount: 'WisWork account',
    aiAccountChecking: 'Checking…',
    aiLoggedIn: 'Signed in',
    aiLoggedInAs: 'Signed in: {email}',
    aiNotLoggedIn: 'Not signed in (AI features require a WisWork account)',
    aiWaitingBrowserLogin: 'Waiting for browser sign-in…',
    aiLoginWisWork: 'Sign in to WisWork',
    aiModel: 'Model',
    aiCancel: 'Cancel',
    aiSave: 'Save',
  ...
  ja: {
    ...
    aiWisWorkAccount: 'WisWork アカウント',
    aiAccountChecking: '確認中…',
    aiLoggedIn: 'サインイン済み',
    aiLoggedInAs: 'サインイン済み: {email}',
    aiNotLoggedIn: '未サインイン（AI 機能には WisWork アカウントへのサインインが必要です）',
    aiWaitingBrowserLogin: 'ブラウザーでのサインインを待機中…',
    aiLoginWisWork: 'WisWork にサインイン',
    aiModel: 'モデル',
    aiCancel: 'キャンセル',
    aiSave: '保存',
  ...
  ko: {
    ...
    aiWisWorkAccount: 'WisWork 계정',
    aiAccountChecking: '확인 중…',
    aiLoggedIn: '로그인됨',
    aiLoggedInAs: '로그인됨: {email}',
    aiNotLoggedIn: '로그인되지 않음(AI 기능을 사용하려면 WisWork 계정 로그인이 필요합니다)',
    aiWaitingBrowserLogin: '브라우저 로그인 대기 중…',
    aiLoginWisWork: 'WisWork 로그인',
    aiModel: '모델',
    aiCancel: '취소',
    aiSave: '저장',
  ...
  fr: {
    ...
    aiWisWorkAccount: 'Compte WisWork',
    aiAccountChecking: 'Vérification…',
    aiLoggedIn: 'Connecté',
    aiLoggedInAs: 'Connecté : {email}',
    aiNotLoggedIn: 'Non connecté (les fonctions IA nécessitent un compte WisWork)',
    aiWaitingBrowserLogin: 'En attente de la connexion dans le navigateur…',
    aiLoginWisWork: 'Se connecter à WisWork',
    aiModel: 'Modèle',
    aiCancel: 'Annuler',
    aiSave: 'Enregistrer',
  ...
  de: {
    ...
    aiWisWorkAccount: 'WisWork-Konto',
    aiAccountChecking: 'Wird überprüft…',
    aiLoggedIn: 'Angemeldet',
    aiLoggedInAs: 'Angemeldet: {email}',
    aiNotLoggedIn: 'Nicht angemeldet (KI-Funktionen erfordern ein WisWork-Konto)',
    aiWaitingBrowserLogin: 'Warten auf Anmeldung im Browser…',
    aiLoginWisWork: 'Bei WisWork anmelden',
    aiModel: 'Modell',
    aiCancel: 'Abbrechen',
    aiSave: 'Speichern',
  ...
  es: {
    ...
    aiWisWorkAccount: 'Cuenta de WisWork',
    aiAccountChecking: 'Comprobando…',
    aiLoggedIn: 'Sesión iniciada',
    aiLoggedInAs: 'Sesión iniciada: {email}',
    aiNotLoggedIn: 'Sin sesión iniciada (las funciones de IA requieren una cuenta de WisWork)',
    aiWaitingBrowserLogin: 'Esperando el inicio de sesión en el navegador…',
    aiLoginWisWork: 'Iniciar sesión en WisWork',
    aiModel: 'Modelo',
    aiCancel: 'Cancelar',
    aiSave: 'Guardar',
  ...
  ru: {
    ...
    aiWisWorkAccount: 'Учётная запись WisWork',
    aiAccountChecking: 'Проверка…',
    aiLoggedIn: 'Вход выполнен',
    aiLoggedInAs: 'Вход выполнен: {email}',
    aiNotLoggedIn: 'Вход не выполнен (для функций ИИ требуется учётная запись WisWork)',
    aiWaitingBrowserLogin: 'Ожидание входа в браузере…',
    aiLoginWisWork: 'Войти в WisWork',
    aiModel: 'Модель',
    aiCancel: 'Отмена',
    aiSave: 'Сохранить',
  ...
  pt: {
    ...
    aiWisWorkAccount: 'Conta WisWork',
    aiAccountChecking: 'Verificando…',
    aiLoggedIn: 'Conectado',
    aiLoggedInAs: 'Conectado: {email}',
    aiNotLoggedIn: 'Não conectado (os recursos de IA exigem uma conta WisWork)',
    aiWaitingBrowserLogin: 'Aguardando login no navegador…',
    aiLoginWisWork: 'Entrar no WisWork',
    aiModel: 'Modelo',
    aiCancel: 'Cancelar',
    aiSave: 'Salvar',
  ...
  nl: {
    ...
    aiNotLoggedIn: 'Niet aangemeld (AI-functies vereisen een WisWork-account)',
    aiWaitingBrowserLogin: 'Wachten op aanmelding in de browser…',
    aiLoginWisWork: 'Aanmelden bij WisWork',
    aiModel: 'Model',
    aiCancel: 'Annuleren',
    aiSave: 'Opslaan',
  ...
  he: {
    ...
    aiWisWorkAccount: 'חשבון WisWork',
    aiAccountChecking: 'בודק…',
    aiLoggedIn: 'מחובר',
    aiLoggedInAs: 'מחובר: {email}',
    aiNotLoggedIn: 'לא מחובר (תכונות AI דורשות חשבון WisWork)',
    aiWaitingBrowserLogin: 'ממתין לכניסה בדפדפן…',
    aiLoginWisWork: 'כניסה ל-WisWork',
    aiModel: 'מודל',
    aiCancel: 'ביטול',
    aiSave: 'שמירה',
  ...
  'zh-TW': {
    ...
    aiWisWorkAccount: 'WisWork 帳號',
    aiAccountChecking: '偵測中…',
    aiLoggedIn: '已登入',
    aiLoggedInAs: '已登入：{email}',
    aiNotLoggedIn: '未登入（AI 功能需要登入 WisWork 帳號）',
    aiWaitingBrowserLogin: '等待瀏覽器登入…',
    aiLoginWisWork: '登入 WisWork',
    aiModel: '模型',
    aiCancel: '取消',
    aiSave: '儲存',
    aiUnknownError: '未知錯誤',
