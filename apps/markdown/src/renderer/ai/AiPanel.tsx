...
export function AiPanel({
  ...
  /** Drag the left edge to resize the right-side dock. */
...
/** WisWork brand mark, inline for crisp device-resolution rendering */
export function WisWorkMark({ size = 18 }: { size?: number }): React.JSX.Element {
  return (
    <svg
      width={size}
      height={size}
