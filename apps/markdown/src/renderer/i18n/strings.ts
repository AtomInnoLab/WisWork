export const strings = {
  zh: {
    ...
    aiCreditsExhausted: '积分不足，请前往 WisWork 充值',
  ...
  en: {
    ...
    aiCreditsExhausted: 'Out of credits — top up at WisWork',
  ...
  ja: {
    ...
    aiCreditsExhausted: 'クレジット不足です。WisWork でチャージしてください',
  ...
  ko: {
    ...
    aiCreditsExhausted: '크레딧이 부족합니다. WisWork에서 충전하세요',
  ...
  fr: {
    ...
    aiCreditsExhausted: 'Crédits épuisés — rechargez sur WisWork',
  ...
  de: {
    ...
    aiCreditsExhausted: 'Guthaben aufgebraucht — bei WisWork aufladen',
  ...
  es: {
    ...
    aiCreditsExhausted: 'Sin créditos — recarga en WisWork',
  ...
  th: {
    ...
    aiCreditsExhausted: 'เครดิตหมด — เติมได้ที่ WisWork',
  ...
  id: {
    ...
    aiCreditsExhausted: 'Kredit habis — isi ulang di WisWork',
  ...
  ru: {
    ...
    aiCreditsExhausted: 'Кредиты закончились — пополните на WisWork',
  ...
  ar: {
    ...
    aiCreditsExhausted: 'نفدت الأرصدة — أعد الشحن على WisWork',
  ...
  pt: {
    ...
    aiCreditsExhausted: 'Créditos esgotados — recarregue em WisWork',
  ...
  it: {
    ...
    aiCreditsExhausted: 'Crediti esauriti — ricarica su WisWork',
  ...
  pl: {
    ...
    aiCreditsExhausted: 'Brak kredytów — doładuj na WisWork',
  ...
  nl: {
    ...
    aiCreditsExhausted: 'Credits op — waardeer op via WisWork',
  ...
  ms: {
    ...
    aiCreditsExhausted: 'Kredit habis — tambah nilai di WisWork',
  ...
  he: {
    ...
    aiCreditsExhausted: 'נגמרו הקרדיטים — טענו ב-WisWork',
  ...
  hi: {
    ...
    aiCreditsExhausted: 'क्रेडिट समाप्त — WisWork पर रिचार्ज करें',
  ...
  'zh-TW': {
    ...
    aiCreditsExhausted: '點數不足，請前往 WisWork 儲值',
