...
import type { RenderNode, RenderSlide, ShapeRenderNode } from '@wiswork/pptx-render'
...
function ShowMediaLayer({
  ...
  const nodes = slide.nodes.filter(
    (n): n is import('@wiswork/pptx-render').PictureRenderNode =>
      n.type === 'picture' && !!(n as import('@wiswork/pptx-render').PictureRenderNode).media,
  )
