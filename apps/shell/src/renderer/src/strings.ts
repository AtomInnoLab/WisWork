...
export const strings = {
  zh: {
    ...
    newSlide: 'AI Slides',
    newLatex: 'LaTeX 项目',
    importLatex: '导入 LaTeX',
    latexProjects: 'LaTeX 项目',
    emptyLatexProjects: '暂无最近的 LaTeX 项目。',
    ...
    fileCount: '{n} 个文件',
    fileCountOne: '{n} 个文件',
    latexProjectCount: '{n} 个 LaTeX 项目',
    latexProjectCountOne: '{n} 个 LaTeX 项目',
    ...
    noContent: '（无内容）',
    // Account
    accountWisWork: 'WisWork 账号',
    account: '账号',
    login: '登录',
    loginWisWork: '登录 WisWork 账号',
    loggedIn: '已登录',
    loggedInWisWork: '已登录 WisWork',
    ...
    loginCopyUrl: '复制登录链接',
    loginCopied: '已复制',
    loginNetworkError: '无法连接 WisWork,请检查网络或代理设置',
  ...
  en: {
    ...
    newSlide: 'AI Slides',
    newLatex: 'LaTeX',
    importLatex: 'Import LaTeX',
    latexProjects: 'LaTeX Projects',
    emptyLatexProjects: 'No recent LaTeX projects.',
    newMarkdown: 'AI Markdown',
    ...
    fileCount: '{n} files',
    fileCountOne: '{n} file',
    latexProjectCount: '{n} LaTeX projects',
    latexProjectCountOne: '{n} LaTeX project',
    ...
    untitled: 'Untitled',
    noContent: '(empty)',
    accountWisWork: 'WisWork Account',
    account: 'Account',
    login: 'Sign in',
    loginWisWork: 'Sign in with WisWork',
    loggedIn: 'Signed in',
    loggedInWisWork: 'Signed in to WisWork',
    ...
    loginCopied: 'Copied',
    loginNetworkError: 'Cannot reach WisWork — check your network or proxy settings',
    ...
    onbBody2: 'WisWork is still in alpha.',
    onbSkip: 'Skip',
    onbNext: 'Next',
  ...
  ja: {
    ...
    noContent: '（内容なし）',
    // Account
    accountWisWork: 'WisWork アカウント',
    account: 'アカウント',
    login: 'サインイン',
    loginWisWork: 'WisWork アカウントでサインイン',
    loggedIn: 'サインイン済み',
    loggedInWisWork: 'WisWork にサインイン済み',
    waitingLogin:
    ...
    loginCopied: 'コピーしました',
    loginNetworkError: 'WisWork に接続できません。ネットワークまたはプロキシ設定を確認してください',
  ...
  ko: {
    ...
    noContent: '(내용 없음)',
    // Account
    accountWisWork: 'WisWork 계정',
    account: '계정',
    login: '로그인',
    loginWisWork: 'WisWork 계정으로 로그인',
    loggedIn: '로그인됨',
    loggedInWisWork: 'WisWork에 로그인됨',
    ...
    loginCopied: '복사됨',
    loginNetworkError: 'WisWork에 연결할 수 없습니다. 네트워크 또는 프록시 설정을 확인하세요',
  ...
  fr: {
    ...
    noContent: '(vide)',
    // Account
    accountWisWork: 'Compte WisWork',
    account: 'Compte',
    login: 'Se connecter',
    loginWisWork: 'Se connecter avec WisWork',
    loggedIn: 'Connecté',
    loggedInWisWork: 'Connecté à WisWork',
    waitingLogin:
    ...
    loginCopied: 'Copié',
    loginNetworkError:
      'Impossible de joindre WisWork — vérifiez votre réseau ou vos paramètres de proxy',
    ...
    // First-run onboarding
    onbTitle1: 'Bienvenue dans WisWork',
    ...
    onbBody2: 'WisWork est encore en phase alpha.',
    onbSkip: 'Passer',
    onbNext: 'Suivant',
    onbStart: 'Commencer',
  ...
  de: {
    ...
    noContent: '(leer)',
    // Account
    accountWisWork: 'WisWork-Konto',
    account: 'Konto',
    login: 'Anmelden',
    loginWisWork: 'Mit WisWork anmelden',
    loggedIn: 'Angemeldet',
    loggedInWisWork: 'Bei WisWork angemeldet',
    waitingLogin:
    ...
    loginCopied: 'Kopiert',
    loginNetworkError:
      'WisWork ist nicht erreichbar — prüfen Sie Netzwerk- oder Proxy-Einstellungen',
    ...
    newTab: 'Neuer Tab',
    // First-run onboarding
    onbTitle1: 'Willkommen bei WisWork',
    ...
    onbBody2: 'WisWork befindet sich noch in der Alpha-Phase.',
  ...
  es: {
    ...
    noContent: '(vacío)',
    // Account
    accountWisWork: 'Cuenta de WisWork',
    account: 'Cuenta',
    login: 'Iniciar sesión',
    loginWisWork: 'Iniciar sesión con WisWork',
    loggedIn: 'Sesión iniciada',
    loggedInWisWork: 'Sesión iniciada en WisWork',
    waitingLogin:
    ...
    loginCopied: 'Copiado',
    loginNetworkError:
      'No se puede conectar con WisWork — compruebe su red o la configuración del proxy',
    ...
    // First-run onboarding
    onbTitle1: 'Bienvenido a WisWork',
    ...
    onbBody2: 'WisWork todavía está en fase alfa.',
    onbSkip: 'Omitir',
    onbNext: 'Siguiente',
    onbStart: 'Empezar',
  ...
  th: {
    ...
    // Account
    accountWisWork: 'บัญชี WisWork',
    account: 'บัญชี',
    login: 'ลงชื่อเข้าใช้',
    loginWisWork: 'ลงชื่อเข้าใช้ด้วย WisWork',
    loggedIn: 'ลงชื่อเข้าใช้แล้ว',
    loggedInWisWork: 'ลงชื่อเข้าใช้ WisWork แล้ว',
    ...
    loginNetworkError: 'ไม่สามารถเชื่อมต่อ WisWork ได้ โปรดตรวจสอบเครือข่ายหรือการตั้งค่าพร็อกซี',
    ...
    newTab: 'แท็บใหม่',
    // First-run onboarding
    onbTitle1: 'ยินดีต้อนรับสู่ WisWork',
    ...
    onbBody2: 'WisWork ยังอยู่ในช่วงอัลฟ่า',
    onbSkip: 'ข้าม',
    onbNext: 'ถัดไป',
  ...
  id: {
    ...
    noContent: '(kosong)',
    // Account
    accountWisWork: 'Akun WisWork',
    account: 'Akun',
    login: 'Masuk',
    loginWisWork: 'Masuk dengan WisWork',
    loggedIn: 'Sudah masuk',
    loggedInWisWork: 'Sudah masuk ke WisWork',
    ...
    loginCopied: 'Disalin',
    loginNetworkError:
      'Tidak dapat terhubung ke WisWork — periksa jaringan atau pengaturan proxy Anda',
    ...
    newTab: 'Tab baru',
    // First-run onboarding
    onbTitle1: 'Selamat datang di WisWork',
    ...
    onbBody2: 'WisWork masih dalam tahap alfa.',
    onbSkip: 'Lewati',
    onbNext: 'Berikutnya',
    onbStart: 'Mulai',
  ...
  ru: {
    ...
    noContent: '(пусто)',
    // Account
    accountWisWork: 'Учётная запись WisWork',
    account: 'Учётная запись',
    login: 'Войти',
    loginWisWork: 'Войти через WisWork',
    loggedIn: 'Вход выполнен',
    loggedInWisWork: 'Выполнен вход в WisWork',
    ...
    loginNetworkError: 'Не удаётся подключиться к WisWork — проверьте сеть или настройки прокси',
    ...
    // First-run onboarding
    onbTitle1: 'Добро пожаловать в WisWork',
    ...
    onbBody2: 'WisWork пока находится в альфа-версии.',
    onbSkip: 'Пропустить',
    onbNext: 'Далее',
    onbStart: 'Начать',
  ...
  ar: {
    ...
    noContent: '(فارغ)',
    // Account
    accountWisWork: 'حساب WisWork',
    account: 'الحساب',
    login: 'تسجيل الدخول',
    loginWisWork: 'تسجيل الدخول باستخدام WisWork',
    loggedIn: 'تم تسجيل الدخول',
    loggedInWisWork: 'تم تسجيل الدخول إلى WisWork',
    ...
    loginNetworkError: 'تعذّر الاتصال بـ WisWork — تحقق من الشبكة أو إعدادات الوكيل',
    ...
    // First-run onboarding
    onbTitle1: 'مرحبًا بك في WisWork',
    ...
    onbBody2: 'لا يزال WisWork في المرحلة التجريبية الأولية.',
    onbSkip: 'تخطي',
    onbNext: 'التالي',
    onbStart: 'ابدأ الآن',
  ...
  pt: {
    ...
    untitled: 'Sem título',
    noContent: '(vazio)',
    accountWisWork: 'Conta WisWork',
    account: 'Conta',
    login: 'Entrar',
    loginWisWork: 'Entrar com a WisWork',
    loggedIn: 'Conectado',
    loggedInWisWork: 'Conectado à WisWork',
    ...
    loginCopied: 'Copiado',
    loginNetworkError:
      'Não foi possível conectar ao WisWork — verifique sua rede ou as configurações de proxy',
    ...
    newTab: 'Nova guia',
    // First-run onboarding
    onbTitle1: 'Bem-vindo ao WisWork',
    ...
    onbBody2: 'O WisWork ainda está em fase alfa.',
    onbSkip: 'Pular',
    onbNext: 'Avançar',
    onbStart: 'Começar',
    onbStepAria: 'Página {n} de {total}',
  ...
  it: {
    ...
    noContent: '(vuoto)',
    accountWisWork: 'Account WisWork',
    account: 'Account',
    login: 'Accedi',
    loginWisWork: 'Accedi con WisWork',
    loggedIn: 'Accesso effettuato',
    loggedInWisWork: 'Accesso effettuato a WisWork',
    ...
    loginCopied: 'Copiato',
    loginNetworkError:
      'Impossibile raggiungere WisWork — controlla la rete o le impostazioni del proxy',
    ...
    newTab: 'Nuova scheda',
    // First-run onboarding
    onbTitle1: 'Benvenuto in WisWork',
    ...
    onbBody2: 'WisWork è ancora in fase alpha.',
    onbSkip: 'Salta',
    onbNext: 'Avanti',
    onbStart: 'Inizia',
  ...
  pl: {
    ...
    untitled: 'Bez tytułu',
    noContent: '(pusto)',
    accountWisWork: 'Konto WisWork',
    account: 'Konto',
    login: 'Zaloguj się',
    loginWisWork: 'Zaloguj się przez WisWork',
    loggedIn: 'Zalogowano',
    loggedInWisWork: 'Zalogowano do WisWork',
    waitingLogin:
    ...
    loginNetworkError: 'Nie można połączyć się z WisWork — sprawdź sieć lub ustawienia proxy',
    ...
    onbBody2: 'WisWork jest nadal w fazie alfa.',
    onbSkip: 'Pomiń',
    onbNext: 'Dalej',
    onbStart: 'Rozpocznij',
  ...
  nl: {
    ...
    account: 'Account',
    login: 'Inloggen',
    loginWisWork: 'Inloggen met WisWork',
    loggedIn: 'Ingelogd',
    loggedInWisWork: 'Ingelogd bij WisWork',
    ...
    loginNetworkError: 'Kan WisWork niet bereiken — controleer uw netwerk of proxyinstellingen',
    ...
    onbBody2: 'WisWork bevindt zich nog in de alfafase.',
    onbSkip: 'Overslaan',
    onbNext: 'Volgende',
  ...
  ms: {
    ...
    noContent: '(kosong)',
    accountWisWork: 'Akaun WisWork',
    account: 'Akaun',
    login: 'Log masuk',
    loginWisWork: 'Log masuk dengan WisWork',
    loggedIn: 'Telah log masuk',
    loggedInWisWork: 'Telah log masuk ke WisWork',
    ...
    loginCopied: 'Disalin',
    loginNetworkError:
      'Tidak dapat menyambung ke WisWork — semak rangkaian atau tetapan proksi anda',
    ...
    newTab: 'Tab baharu',
    // First-run onboarding
    onbTitle1: 'Selamat datang ke WisWork',
    ...
    onbTitle2: 'Ini baru permulaan',
    onbBody2: 'WisWork masih dalam peringkat alfa.',
    onbSkip: 'Langkau',
    onbNext: 'Seterusnya',
    onbStart: 'Mula',
  ...
  he: {
    ...
    untitled: 'ללא שם',
    noContent: '(ריק)',
    accountWisWork: 'חשבון WisWork',
    account: 'חשבון',
    login: 'התחברות',
    loginWisWork: 'התחברות עם WisWork',
    loggedIn: 'מחובר',
    loggedInWisWork: 'מחובר ל-WisWork',
    ...
    loginCopied: 'הועתק',
    loginNetworkError: 'לא ניתן להתחבר ל-WisWork — בדקו את הרשת או את הגדרות ה-proxy',
    ...
    // First-run onboarding
    onbTitle1: 'ברוכים הבאים ל-WisWork',
    ...
    onbBody2: 'WisWork עדיין בשלב אלפא.',
    onbSkip: 'דילוג',
    onbNext: 'הבא',
    onbStart: 'להתחיל',
  ...
  hi: {
    ...
    noContent: '(खाली)',
    accountWisWork: 'WisWork खाता',
    account: 'खाता',
    login: 'साइन इन करें',
    loginWisWork: 'WisWork से साइन इन करें',
    loggedIn: 'साइन इन हो गया',
    loggedInWisWork: 'WisWork में साइन इन है',
    waitingLogin:
    ...
    loginNetworkError: 'WisWork से कनेक्ट नहीं हो सका — नेटवर्क या प्रॉक्सी सेटिंग जांचें',
    ...
    newTab: 'नया टैब',
    // First-run onboarding
    onbTitle1: 'WisWork में आपका स्वागत है',
    ...
    onbBody2: 'WisWork अभी अल्फ़ा चरण में है।',
    onbSkip: 'छोड़ें',
    onbNext: 'आगे',
    onbStart: 'शुरू करें',
  ...
  'zh-TW': {
    ...
    untitled: '未命名',
    noContent: '（無內容）',
    accountWisWork: 'WisWork 帳號',
    account: '帳號',
    login: '登入',
    loginWisWork: '登入 WisWork 帳號',
    loggedIn: '已登入',
    loggedInWisWork: '已登入 WisWork',
    ...
    loginCopyUrl: '複製登入連結',
    loginCopied: '已複製',
    loginNetworkError: '無法連線至 WisWork，請檢查網路或代理設定',
