...
const SIDEBAR_W_KEY = 'wiswork-pdf-sidebar-width'
    ...
    <div className="app">
      <div className="ribbon">
        ...
        <div className="ribbon-body">
          {ribbonTab === 'home' && (
            <>
              {/* ---- WisWork AI (first slot: entry + one-click AI actions, docs parity) ---- */}
              <div className="ribbon-group">
                <div className="ribbon-group-items">
                  <button
      ...
      <div className="app-main">
        ...
        {/* Final/rightmost workspace child. The mounted panel keeps chat and
            in-flight state while collapsed. */}
