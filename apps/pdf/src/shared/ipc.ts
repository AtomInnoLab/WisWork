import type { Lang } from '@wiswork/i18n'
...
export const VISUAL_SIGNATURE_CONTENT_PREFIX = 'WisWork visual signature field: '
...
/** Editable metadata for a WisWork static form fill embedded as a page image. */
...
export interface PdfApi {
  ...
  /** Read WisWork static-fill metadata stored inside the PDF. */
  ...
  /** AI image generation through the host-provided WisWork transport. */
