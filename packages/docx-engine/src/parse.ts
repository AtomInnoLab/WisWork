...
/**
 * Decode numeric character references that fast-xml-parser intentionally leaves
 * unresolved. Named entities read from the parse tree have already been decoded
 * once and must not pass through the named-entity replacements again.
 */
...
/** Full entity decode for raw XML slices that have not passed through xmlParser. */
