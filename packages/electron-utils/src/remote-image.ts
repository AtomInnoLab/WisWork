/// Downloader for AI-inserted images. Browser-like headers and a small retry
/// budget turn transient CDN failures into successful inserts without binding
/// the shared downloader to a particular provider.
