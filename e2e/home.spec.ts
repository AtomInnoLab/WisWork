...
test.describe('home screen', () => {
  test('shows hero, quick-create cards and tab bar', async () => {
    ...
    try {
      ...
      // four AI create cards, LaTeX import, and the "Open file" browse card
      ...
      await expect(page.getByTestId('quick-new-tex')).toContainText('LaTeX')
      await expect(page.getByTestId('quick-import-latex')).toContainText('Import LaTeX')
  ...
  test('renders localized UI when WISWORK_LANG=zh-CN', async () => {
