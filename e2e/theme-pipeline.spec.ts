...
import { launchShell, terminateShell, waitForPageWithUrl } from './helpers'
...
test.describe('theme pipeline', () => {
  test('setTheme reaches home and editor tabs', async () => {
    const dir = await mkdtemp(join(tmpdir(), 'wiswork-theme-'))
